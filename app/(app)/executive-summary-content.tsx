...
const COMMITMENTS = [
  ...
  },
  {
    ...
    provenance:
      'The IBISWorld line uses AUD $2,500 — the live AU checkout cart price, accessed 2026-08-23. The vendor’s help centre publishes AU$2,200 for the same single report, which is also the mandate’s ground-truth baseline (GT D5-[15], graded VERIFIED with caveat in verify/ibisworld-reaudit.md). Both are the vendor’s own published prices; the transactional cart price is the one used for planning (financial_rebuild.md §A.1.2 P1). At the A$2,200 baseline the same gate reads: floor A$5,560.00 [DERIVED]: 2,200 + 3,360 = 6.70× the anchor, and full A$9,576.74 [DERIVED]: 2,200 + 3,342.20 + 194.54 + 3,840 = 11.54×; the data-floor line is 2.65× [DERIVED]: 2,200 ÷ 830. Statista Starter (A$3,342.20 [DERIVED] inside the full configuration) is priced from the vendor’s own published tier, US$199/mo billed annually. The mandate’s ground-truth baseline for Statista — GT D5-[16], “Statista Personal: A$922/yr” — is deliberately NOT carried: verify/statista-reaudit.md grades it NOT FOUND, no tier at or near A$922/yr appearing on the published page in any currency, the cheapest paid tier being Starter at US$199/mo. Unlike the IBISWorld variance above, the two are not competing vendor-published prices, so no dual-baseline restatement of this gate is possible — the published figure stands and the GT entry is recorded as unverifiable against its primary source. Commitment scope adjudicated VERIFIED (CL-0017). Costs: financial_rebuild.md §E.4 Gate G2, §A.3, §C.2–C.3, §D.2.5; IBISWorld live AU checkout cart; Statista and Semrush published tiers (all accessed 2026-08-23). FX: RBA rate 21 Aug 2026, USD 0.7145 per A$1.',
  },
];
