...
const COMMITMENTS = [
  ...
  },
  {
    ...
    detail:
      'With economics and inventory confirmed: a minimum viable data platform (3 certified dashboards — certification meaning dbt tests plus named sign-off, a process, not a licence — a reconciled finance mart, basic consent management) and a 3–5 event Australian pilot. Priced components per line in the table below.',
    provenance:
      'Commitment scope adjudicated VERIFIED (CL-0017). Costs: financial_rebuild.md §E.4 Gate G2, §A.3, §C.2–C.3, §D.2.5; IBISWorld live AU checkout cart; Statista and Semrush published tiers (all accessed 2026-08-23). FX: RBA rate 21 Aug 2026, USD 0.7145 per A$1.',
  },
];
