...
export function SiteFooter() {
  return (
    <footer className="relative z-10 border-t border-border/60 px-5 pb-10 pt-6 lg:ml-64 lg:px-10">
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-2 text-xs text-muted-foreground sm:flex-row sm:items-center sm:justify-between">
        <p>© 2026 Global Initiative - Ticketing Platform · A product of V2 Group Pty. Ltd. · All rights reserved.</p>
