...
export const MARKETS: Market[] = [
  ...
  },
  {
    ...
    heroTilesIntro:
      'Every monetary figure on this page carries one of the sanctioned provenance markers, and this page declares no labelled exception of its own. On the closure pass (F-04) the exception it did declare was withdrawn: the UK live-music consumer-spend figure was published here under the label “Trade-body estimate”, a marker this audit minted for itself rather than one drawn from the sanctioned set the audit pack defines. No sanctioned marker fits a trade federation’s own commissioned market-size estimate — the vendor-price marker means exactly that, a price the vendor publishes — so the figure is not republished under a new label: it is withdrawn, and the market size it stood for is published as [UNKNOWN]. Nothing downstream moves, because under the trust ladder that figure already fed no headline tier and no funded figure (verify/uk-stats.md §2). The non-monetary official statistics below carry their source lines, untagged, per the site-wide convention.',
    heroTiles: [
      {
        label: 'Live-music market size, UK',
        value: '[UNKNOWN]',
        note: 'No figure is published. The only measure located is a trade federation’s own commissioned estimate of 2024 consumer spend (LIVE, Annual Report & Economic Highlights 2024, +9.5% year-on-year), which earns none of the sanctioned provenance markers; the earlier “Trade-body estimate” label was invented by this audit and is withdrawn (closure pass, F-04). No official statistic of UK live-music market size was located. The original page’s own version of this figure was worse on two counts: mis-attributed to DCMS, and converted at an assumed GBP 1 = AUD 2.00, about 4.7% above the RBA rate of 1.9106 (verify/fx-rates.md).',
      },
      {
    ...
    evidence:
      'No figure for UK live-music market size is published on this page: the market size is [UNKNOWN]. The measure carried here on earlier passes — a trade federation’s own commissioned estimate of 2024 consumer spend, correctly re-attributed from DCMS to LIVE but then published under the invented label “Trade-body estimate” — is withdrawn on the closure pass (F-04), and with it the AUD conversion that inherited that label. Neither is replaced by a re-labelled version: no sanctioned provenance marker fits a trade body’s commissioned estimate, and this page mints none. Nothing that depended on it moves, because it fed no headline tier and no funded figure. In England, 90.6% of adults engaged with the arts in 2024/25 — a broad engagement measure, not live-event attendance specifically. The UN estimated 11.8 million international migrants in the UK in 2024. These figures indicate strong general cultural demand; none of them quantifies Marathi or Indian-origin event buyers, and that count does not exist in any source consulted for this page.',
    evidenceSources: [
      'Arts engagement: DCMS, Participation Survey 2024/25 — gov.uk',
      'Migrant stock: UN DESA, International Migrant Stock 2024 — un.org',
      'Withdrawn figure (kept for audit trail, published nowhere on this page): LIVE, Annual Report & Economic Highlights 2024 — livemusic.biz; FX comparison at RBA daily rates, 21 Aug 2026 — rba.gov.au. All accessed 2026-08-23.',
    ],
    cadence: {
      title: 'Data cadence — what no purchase can refresh',
      body:
        'The DCMS Participation Survey is an annual series: 2024/25 is the latest annual publication and 2023/24 its predecessor, so UK arts-engagement evidence moves once a year and no payment accelerates it. The LIVE consumer-spend series would have to be read from 2018 to the latest year if it were ever read at all — a window that opens inside the 2020–21 collapse manufactures growth out of the rebound, so a single year’s movement cannot be read as a structural rate — and no figure from that series is published on this page (see the withdrawn-figure note above). Both back-catalogues are free downloads — the binding limit on what gate-G1 discovery can know here is release cadence, not budget.',
      source:
    ...
    sizingOpenItems: [
      {
        ...
        unknown:
          'No bottom-up event inventory has been built for the UK; both original ranges have been deleted rather than republished, and the whole-market consumer-spend figure previously shown as TAM — GBP 6.68bn, or approximately AUD 12.8bn at the RBA rate GBP 1 = AUD 1.9106, named here once as the withdrawn figure and published nowhere on this site as a live claim — has been withdrawn: first from the TAM tier, and on the closure pass (F-04) from this page altogether, because it carried a provenance label this audit invented for it rather than a sanctioned marker, and no sanctioned marker fits a trade body’s own commissioned estimate. A whole-national-market spend total is not a total addressable market for this programme in any case, since this page’s own reading is that Ticketalay’s addressable niche within it is a fraction of one percent, never sized bottom-up — published as a TAM it overstates the addressable market by more than two orders of magnitude. It also left the United Kingdom as the only market on this site carrying a whole-market headline, where Australia’s TAM/SAM/SOM are deleted outright, Canada is “Not sized”, the European Union is country-specific and not sized, and the United States TAM stands as an open item with SAM [UNKNOWN].',
  ...
  },
  {
    ...
    heroTilesIntro:
      'One marker on this page needs its definition stated: [OFFICIAL] means an official statistic or a statutory filed record, deep-linked in workflow/verify/ — here Live Nation’s FY2025 Form 10-K on SEC EDGAR. It records how the figure enters this programme’s ledger, not the source’s rank: on the trust ladder an audited filing still sits one rung below an official statistic, and nothing is laundered upward by carrying the marker. Added on the closure pass (F-04), replacing the label “Audited filing”, which this audit had minted for itself.',
    heroTiles: [
      {
      ...
      },
      {
        ...
        value: '646,000,000',
        note: '[OFFICIAL] — of which 346,000,000 were fee-bearing, on US$37.1 billion [OFFICIAL] of fee-bearing GTV. Live Nation Entertainment FY2025 Form 10-K, a statutory SEC filing (verify/us-stats.md). A take-rate/unit-economics benchmark only, per the trust ladder, which still grades an audited filing one rung below an official statistic; the marker records how the figure enters this ledger, not its tier. Closure pass, F-04: the cell previously carried the label “Audited filing”, invented by this audit and in no sanctioned marker set.',
      },
    ],
    hotspots: [
