...
export const VENDOR_PRICES = [
  ...
  },
  {
    ...
    disposition:
      'Starter conditionally in the G2 full tranche at A$3,342.20/yr [DERIVED] — purchase order only against a written gap-list of statistics the free sources failed to supply. Aggregator: every figure must be re-cited to its primary source. For the Personal tier two figures are carried side by side: the mandate’s ground-truth register records A$922/yr [LIST] (GT D5-[16]) and the vendor’s published page shows US$649/mo billed annually [LIST]. Neither is graded here — the register is the operative baseline, its D5 source line sits in the corpus that is not on this machine, and the reconciliation is open item U-01, owned by the programme sponsor. No funded line on this page prices the Personal tier: the G2 tranche buys Starter. (Closure pass, F-03: this row previously recorded the GT entry as “NOT carried … unverifiable against its primary source”; no live page adjudicates a ground-truth entry.)',
  },
  {
    provider: 'Semrush',
