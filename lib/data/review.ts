...
export const PRIORITY_RECOMMENDATIONS: PriorityRecommendation[] = [
  ...
  },
  {
    ...
    openItem: {
      ...
      unknown:
        'Two conflicting interview counts (15–20 at this stage; 10–15 in the 90-day roadmap below and on the Australia market page) previously appeared for the same programme step with no ledger-recorded correct figure, so no count is stated.',
      owner:
...
export const ROADMAP_90_DAYS = [
  ...
  { milestone: 'M2: DISCOVERY', timeline: 'Days 31–60', deliverable: 'Data catalogue, quality scorecard, baseline unit economics, a programme of promoter interviews', outcome: 'G1 discovery evidence in hand: primary demand study delivered, signed pilot counterparties (or dated LOIs) secured' },
