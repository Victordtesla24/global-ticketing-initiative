...
export const MARKETING_DATA_PLAN = [
  ...
  },
  {
    ...
    acquire: 'Google Maps geocoding at 100,000 calls/yr: USD 0–450/yr [LIST] — within Google\'s free monthly cap, which the original page\'s AUD 775 floor ignored. OpenCage: USD 600/yr (X-Small tier) [LIST] is sufficient for this workload — the “Medium” tier the original page priced at AUD 930–2,800 is actually USD 6,000/yr and is oversized for it.',
